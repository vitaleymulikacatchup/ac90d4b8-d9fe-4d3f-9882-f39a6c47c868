...
export const metadata: Metadata = {
  title: "Subhadeep - Full-Stack Web Developer | Modern Web Solutions",
  description: "Professional web developer specializing in React, Next.js, and full-stack development. Creating modern, responsive web applications that drive results.",
  keywords: "web developer, full-stack developer, React developer, Next.js, frontend development, backend development, portfolio",
  openGraph: {
    title: "Subhadeep - Full-Stack Web Developer",
    description: "Professional web developer creating modern, responsive web applications with cutting-edge technologies.",
    siteName: "Subhadeep Portfolio",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/4974922/pexels-photo-4974922.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Subhadeep web developer portfolio"
    }]
  },
  twitter: {
